...
full_speeches <- readRDS("..//data//full_speeches.RDAT") # a tibble of lords and all their speeches (concatenated together)
appearances_tib <- readRDS("..//data//appearances.RDAT") # a tibble of all the speeches in the chronological order they were made
