...
full_speeches <- readRDS("..//data//full_speeches_2.RDAT") # a tibble of lords and all their speeches (concatenated together)
appearances_tib <- readRDS("..//data//appearances_2.RDAT") # a tibble of all the speeches in the chronological order they were made
party_id_tib <- readRDS("..//data//party_id_tib.RDAT") # a tibble containing each lords party and gender. 
...
knitr::include_graphics("../drawings/exp_vs_res.png")
```
...
knitr::include_graphics("../drawings/hans_names.png")
```
