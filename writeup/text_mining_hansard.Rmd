...
# For some reason, even in the original "eu" text file, the formatting removes Lord Pannick's
...
```{r, fig.height = 12, fig.width=15, fig.cap="The position of words on the y axis is irrelevant!"}
library(ggrepel)
