...
In this article, I applied tidy text mining methods such as tokenisation into bigrams, sentiment analysis, topic modelling, and text summarisation to try and gain more insight into a Hansard debate. There are many things I've not included, notably supervised machine learning for text classification, and linguistic analysis like Part-Of-Speech tagging. Both of these methods could readily be integrated into this kind of analysis. 
...
Such tools should one day form a core part of a political transparency and accountability. The [house of commons library](https://commonslibrary.parliament.uk/about-us/) publishes research by independent experts who also provide impartial briefings to MPs on issues. This is really great. Earlier in the article I also linked to the House of Lords [research briefings](https://researchbriefings.parliament.uk/). But I think this is only one part of transparency required for a proper functioning democracy. There is no substitute for giving people the power to dig into the data themselves. Often in such curated analysis the end product is nice but the analytical process is obscured. There are articles with really interesting ideas like this [YouGov piece](https://yougov.co.uk/topics/politics/articles-reports/2019/01/29/16-groups-brexit), but leave you to wonder how they got there. What were the limitations of their approach? Let us see the guts and grime, and make the data available in an accessible format so we can reproduce the analysis for ourselves. As such, open source tools like those built in R I think really have the power to change how people participate in politics in a more intimate sense. You cannot get closer to the reality of parliamentary opinion than the Hansards themselves.  
